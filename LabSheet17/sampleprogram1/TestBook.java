...
//TestBook.java
/*A driver class for the Book class. This contains try-catch code to handle both IllegalArgumentExceptions
...
public class TestBook {
    public static void main(String[] args) {
        String output = "";
        boolean valid = false;
        labsheet16.exercise1solution.Book book1, book2 = null;

        book1 = new labsheet16.exercise1solution.Book();
